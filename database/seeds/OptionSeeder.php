...
class OptionSeeder extends Seeder
{
    ...
    public function run()
    {
        $options = array(
            ...
            'allowed_file_types' => 'jpeg,png,jpg,pdf,zip,doc,docx,xls,ppt,mp4,xlsm,m4a',
            'is_preview' => '1',
            'admin_share' => '20',
            'instructor_share' => '80',
            ...
            'about_us_page' => '3',
            'cookie_alert' => 'json_encode_value_{"enable":"1","message":"By using CosmoEduLMS you accept our cookies and agree to our privacy policy, including cookie policy. {privacy_policy_url}"}',

...
class LP_Button_Video extends Widget_Base {
	...
	public function get_title() {
		return __( 'LP - Button Video Popup / Lightbox', 'landingpress-wp' );
	}
	...
	protected function render() {
		...
		$this->add_render_attribute( 'button', 'class', 'elementor-magnific-popup-video' );
		$this->add_render_attribute( 'button', 'class', 'elementor-button-link' );

		$youtube_id = $this->get_youtube_id( $settings['video'] );
		if ( !empty( $youtube_id ) ) {
			$this->add_render_attribute( 'button', 'href', 'http://www.youtube.com/watch?v='.$youtube_id );
		}
		else {
			$this->add_render_attribute( 'button', 'href', esc_url( $settings['video'] ) );
		}

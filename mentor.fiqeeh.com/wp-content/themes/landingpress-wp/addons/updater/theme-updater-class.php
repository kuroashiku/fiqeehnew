...
class EDD_Theme_Updater {
	...
	function __construct( $args = array(), $strings = array() ) {
		...
		add_action( 'load-index.php',                      array( $this, 'load_themes_screen' ) );
		add_action( 'load-nav-menus.php',                  array( $this, 'load_themes_screen' ) );
		add_action( 'load-widgets.php',                    array( $this, 'load_themes_screen' ) );
		add_action( 'load-theme-editor.php',               array( $this, 'load_themes_screen' ) );
		add_action( 'load-plugins.php',                    array( $this, 'load_themes_screen' ) );
		add_action( 'load-users.php',                      array( $this, 'load_themes_screen' ) );
		add_action( 'load-tools.php',                      array( $this, 'load_themes_screen' ) );
		add_action( 'load-options-general.php',            array( $this, 'load_themes_screen' ) );
		add_action( 'load-users.php',                      array( $this, 'load_themes_screen' ) );
	}
	...
	function theme_update_transient( $value ) {
		...
		if ( !empty($update_data) && isset($value->response) ) {

...
@section('content')
    ...
    <form action="{{route('survey_store')}}" method="post" enctype="multipart/form-data"> @csrf
        ...
        <div class="row">
            ...
            <div class="col-md-12">
                ...
                <div class="form-group row {{ $errors->has('question')? 'has-error':'' }} ">
                    ...
                    <div class="col-sm-7">
                        <input type="text" name="question" value="" placeholder="Question Test" id="question" class="form-control">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-7">
                        <label><input type="radio" name="publish" value="1" checked="checked"> {{__a('publish')}}</label> <br />
                        <label><input type="radio" name="publish" value="0"> {{__a('unpublish')}}</label>
                    </div>
                </div>

        ...
        <div class="col-md-10 col-xs-12">
            ...
            <form action="{{route('save_settings')}}" method="post">
                ...
                <div class="form-group row {{ $errors->has('price')? 'has-error':'' }}">
                    <label for="price" class="col-sm-4 control-label">Membership Price</label>
                    <div class="col-sm-8">
                        <input type="text" class="form-control" id="price" value="{{ old('price')? old('price') : get_option('price') }}" name="price" placeholder="Biaya Membership Price">

<tr class="bg-category-step{{$category->step}}">
    ...
    <td>
        ...
        @if ($category->step == 2 && $category->show_home == 0)
            <a href="#" onclick="addToHome({{$category->id}})" class="btn btn-success btn-sm"> Show In Home </a>
        @elseif ($category->step == 2 && $category->show_home == 1)
            <a href="#" onclick="removeFromHome({{$category->id}})" class="btn btn-warning btn-sm"> Remove From Home </a>
        @endif
    </td>
    <td>

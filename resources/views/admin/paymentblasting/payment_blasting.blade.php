...
@include('admin.paymentsblasting.menu')
    <form method="get">
                                                    ...
                                                    <div class="modal-body">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <select class="form-control single-select-field-edit" name="category_product" id="category_product_edit" data-placeholder="Select Category">
                                                                ...
                                                                @if ($payment->category_product = 1185)
                                                                    <option value="{{ $payment->category_product }}" selected>Mindset</option>
                                                                    @elseif($payment->category_product = 1186)
                                                                    <option value="{{ $payment->category_product }}" selected>Produk</option>
                                                                    @elseif($payment->category_product = 1188)
                                                                    <option value="{{ $payment->category_product }}" selected>Permodalan</option>
                                                                    @elseif($payment->category_product = 1190)
                                                                    <option value="{{ $payment->category_product }}" selected>Pemasaran</option>
                                                                    @elseif($payment->category_product = 1191)
                                                                    <option value="{{ $payment->category_product }}" selected>Operasional</option>
                                                                    @elseif($payment->category_product = 1203)
                                                                    <option value="{{ $payment->category_product }}" selected>Member Jual Produk</option>
                                                                    @elseif($payment->category_product = 1205)
                                                                    <option value="{{ $payment->category_product }}" selected>Member Cari Mitra</option>
                                                                    @elseif($payment->category_product = 1206)
                                                                    <option value="{{ $payment->category_product }}" selected>Member Cari Investor</option>
                                                                    @elseif($payment->category_product = 1207)
                                                                    <option value="{{ $payment->category_product }}" selected>Fiqeeh Buku</option>
                                                                    @elseif($payment->category_product = 1208)
                                                                    <option value="{{ $payment->category_product }}" selected>Fiqeeh Workshop</option>
                                                                    @elseif($payment->category_product = 1209)
                                                                    <option value="{{ $payment->category_product }}" selected>Fiqeeh Konsultan</option>
                                                                    @elseif($payment->category_product = 1210)
                                                                    <option value="{{ $payment->category_product }}" selected>Fiqeeh Ads</option>
                                                                    @elseif ($payment->category_product == 1)
                                                        ...
                                                        @endif
                                                            <div class="form-group">
                                                                ...
                                                                <select class="form-control" name="product">
                                                                    <option value="{{$payment->product}}" selected hidden>{{$payment->product}}</option>
                                                                    <option value="Kampus Bisnis Syariah">Kampus Bisnis Syariah</option>
                                                                    @foreach ($cours as $item)

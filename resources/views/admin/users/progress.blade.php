...
@include('admin.users.menu')
        ...
        <div class="row">
            ...
            <div class="col-md-5">
                ...
                {{-- <button type="button" class="btn btn-info text-right" data-toggle="modal" data-target="#uploadUser"><i class="la la-upload"></i> Upload User</button> --}}
                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-body row">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        @php
                                            $cours = \App\Course::where('category_id','!=',1203)->get()
                                        @endphp
                                        <div class="form-group">
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-8">
                                                ...
                                                <p class="help-block">Sample File : <a href="{{ asset('assets/files/Sample File CRM.xlsx') }}" target="_blank" rel="noopener noreferrer">.xlsx</a></p>
                                        ...
                                        @foreach ($u['user_enrolls'] as $item)
                                            @if(isset($item['course']))
                                                <tr>
                                                    ...
                                                    <td>{{ date('d/m/Y', strtotime($u->expired_package_at)) }}</td>
                                                    <td>

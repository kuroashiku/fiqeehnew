                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-body row">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        @php
                                            $tescategory = \App\Category::where('id', '!=', 1160)->where('id', '!=', 1161)->get();
                                        @endphp
                                        <div class="form-group">
                                            <label for="recipient-name" class="col-form-label">Product Category :</label><br>
                                            <select class="form-control single-select-field" name="category_product" id="category_product" data-placeholder="Select Category" required>
                                                <option value=""></option>
                                                @foreach ($tescategory as $item)
                                        ...
                                        @php
                                            $cours = \App\Course::orderBy('title','asc')->get();
                                        @endphp 
                                        <div class="form-group">
                                            <label for="recipient-name" class="col-form-label">Product:</label>
                                            <select class="form-control" name="product" id="product" data-placeholder="Select Product" required>
                                        ...
                                        @endphp 
                                        <div class="form-group" id="adscat" hidden>
                    ...
                    <div class="search-filter-form-wrap mb-3">
                        <div class="input-group">
                                ...
                                <select name="filter_data" class="form-control mr-1">
                                    ...
                                    <option value="last_payment_pending" {{selected('last_payment_pending', request('filter_data'))}}>Last Payment Pending</option>
                                </select>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        @elseif ($u->category_product == 3)
                                                            Fiqeeh Ads
                                                        @elseif ($u->category_product == 1185)
                                                            Mindset 
                                                        @elseif ($u->category_product == 1186)
                                                            Produk
                                                        @elseif ($u->category_product == 1188)
                                                            Permodalan
                                                        @elseif ($u->category_product == 1190)
                                                            Pemasaran
                                                        @elseif ($u->category_product == 1191)
                                                            Operasional
                                                        @elseif ($u->category_product == 1203)
                                                            Member Jual Produk
                                                        @elseif ($u->category_product == 1205)
                                                            Member Cari Mitra
                                                        @elseif ($u->category_product == 1206)
                                                            Member Cari Investor
                                                        @elseif ($u->category_product == 1207)
                                                            Fiqeeh Buku
                                                        @elseif ($u->category_product == 1208)
                                                            Fiqeeh Workshop
                                                        @elseif ($u->category_product == 1209)
                                                            Fiqeeh Konsultan
                                                        @elseif ($u->category_product == 1210)
                                                            Fiqeeh Ads
                                                        @endif
                                                    </td>
                                                    @if($u->product == null) 
                                                                ...
                                                                <form method="POST" action="{{ route('edit-user', $u->id) }}">
                                                                    <div class="modal-content">
                                                                        ...
                                                                        <div class="modal-body">
                                                                            ...
                                                                            <div class="form-group">
                                                                                <label for="recipient-name" class="col-form-label">Product Category :</label><br>
                                                                                <select class="form-control single-select-field-edit" name="category_product" id="category_product_edit" data-placeholder="Select Category">
                                                                                @if ($u->category_product = 1185)
                                                                                <option value="{{ $u->category_product }}" selected>Mindset</option>
                                                                                @elseif($u->category_product = 1186)
                                                                                <option value="{{ $u->category_product }}" selected>Produk</option>
                                                                                @elseif($u->category_product = 1188)
                                                                                <option value="{{ $u->category_product }}" selected>Permodalan</option>
                                                                                @elseif($u->category_product = 1190)
                                                                                <option value="{{ $u->category_product }}" selected>Pemasaran</option>
                                                                                @elseif($u->category_product = 1191)
                                                                                <option value="{{ $u->category_product }}" selected>Operasional</option>
                                                                                @elseif($u->category_product = 1203)
                                                                                <option value="{{ $u->category_product }}" selected>Member Jual Produk</option>
                                                                                @elseif($u->category_product = 1205)
                                                                                <option value="{{ $u->category_product }}" selected>Member Cari Mitra</option>
                                                                                @elseif($u->category_product = 1206)
                                                                                <option value="{{ $u->category_product }}" selected>Member Cari Investor</option>
                                                                                @elseif($u->category_product = 1207)
                                                                                <option value="{{ $u->category_product }}" selected>Fiqeeh Buku</option>
                                                                                @elseif($u->category_product = 1208)
                                                                                <option value="{{ $u->category_product }}" selected>Fiqeeh Workshop</option>
                                                                                @elseif($u->category_product = 1209)
                                                                                <option value="{{ $u->category_product }}" selected>Fiqeeh Konsultan</option>
                                                                                @elseif($u->category_product = 1210)
                                                                                <option value="{{ $u->category_product }}" selected>Fiqeeh Ads</option>
                                                                            ...
                                                                            <div class="form-group">
                                                                                <label for="recipient-name" class="col-form-label">Product:</label>
                                                                                <select class="form-control" name="product" id="" data-placeholder="Select Product">
                                                                                    <option value="{{$u->product}}"selected hidden>{{$u->product}}</option>
                                                                                    <option value="Kampus Bisnis Syariah">Kampus Bisnis Syariah</option>
                                                                                    @foreach ($cours as $item)
                                                                            ...
                                                                            {{-- <div class="form-group">
                                                                                <label for="recipient-name" class="col-form-label">Product:</label>
                                                                                <select class="form-control" name="product" id="product" data-placeholder="Select Product">
                                                                                    <option value="" selected hidden>Pilih Product</option>
                                                                                    <option value="Kampus Bisnis Syariah">Kampus Bisnis Syariah</option>
                                                                                    @foreach ($cours as $item)
                                                                                        @if ($u->product == $item->title)
                                                                        ...
                                                                        <div class="modal-body row">
                                                                            ...
                                                                            <div class="col-md-12">
                                                                                <div class="form-group">
                                                                                    ...
                                                                                    <input type="text" class="form-control" name="text_phone" value="{{ $u->phone }}" autocomplete="off">
                                                                                </div>
                                                                            </div>
                                                                            <div class="col-md-12">
                                                                                @php
...
Perkenalkan nama saya Ayu Admin Fiqeeh, kakak membeli kelas online
...
3. MASA BELAJAR: 
{{date('d M Y', strtotime($u->created_at))}} - {{date('d M Y', strtotime($u->expired_package_at))}}

4. TANYA COACH YUDHA DI GRUP:
FIQEEH {{$u->city}}
                                                                            ...
                                                                            <div class="col-md-12">
                                                                                <div class="form-group">
                                                                                    ...
                                                                                    <textarea name="text_blast3" class="form-control" rows="10" >
5. CARA BELAJAR:
Klik: https://fiqeeh.com/login
Masuk: {{$u->phone}} & sandi: 123456
Klik Tombol: Mulai Belajar

Lihat tutorial disini
https://youtube.com/shorts/ME8y-aKXhk4

Bisa coba sekarang kak? Kabari saya ☺

Ayu Admin Fiqeeh
Fiqeeh.com | Kampus Bisnis Syariah
                                                                                    </textarea>
                                                                                </div>
                                                                            </div>
                                                                            <input type="hidden" name="last_product" value="{{@$_GET['last_product']}}">

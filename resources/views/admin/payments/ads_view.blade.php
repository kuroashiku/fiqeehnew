...
@section('page-header-right')
    <a href="{{route('paymentsads')}}" data-toggle="tooltip" title="Payments Ads"> <i class="la la-arrow-circle-left"></i> Back To Payments Ads </a>
@endsection
    ...
    @if ($verified == 0)
        <form action="{{route('update_status', $payment->id)}}" class="form-inline" method="post">
            ...
            <div class="status-update-form-wrap d-flex p-3 bg-light">
                <span class="mr-2">Update Payment Ads Status</span>

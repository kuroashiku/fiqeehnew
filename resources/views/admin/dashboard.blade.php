...
@section('content')
    ...
    @php
        ...
        $totalLogin = \app\User::whereUserType('student')->whereDate('last_login', date('Y-m-d'))->count();
        $lastUserId = \app\User::max('id');
        $month = Null;
        $year = Null;
        ...
        $totalLoginMonth = \app\User::whereUserType('student')->whereBetween('last_login',[$startMonth,$endMonth])->count();
    ...
    <div class="row">
        ...
        <div class="col-lg-3 col-md-6">
            <div class="dashboard-card mb-3 d-flex border p-3 bg-light">
                ...
                <div class="card-info">
                    <div class="text-value">
                        <h4>{{ $totalLoginMonth }}</h4>
                    </div>
                    <div>Login This Month
                    </div>
                </div>
            </div>
        </div>

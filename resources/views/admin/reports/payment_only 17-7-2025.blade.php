    ...
    <div class="profile-settings-wrap">
        ...
        <table class="table table-striped table-bordered">
            ...
            <tr>
                ...
                <th style="width:20%;">Tanggal Payment</th>
                <th>Nama</th>
                <th>No Hp</th>
                <th>Produk</th>
                <th>Nilai</th>
        ...
        {!! $students->appends(['q' => request('q'), 'status'=> request('status'),'city'=> request('city'),'city'=> request('city'),'age'=> request('age'),'job_title'=> request('job_title'),'product'=> request('product'), 'start_date'=> request('start_date'), 'end_date'=> request('end_date')])->links() !!}

...
@include('admin.reports.menu')
    ...
    <div class="profile-settings-wrap">
        ...
        <h4 class="mb-3">Laporan Login</h4>
                        ...
                        <div class="search-filter-form-wrap mb-3">
                            ...
                            <div class="input-group">
                                ...
                                <select name="category" class="form-control mr-1">
                                    ...
                                    <option value="1203" {{selected('1203', request('category'))}} >Member Jual Produk</option>
                                    <option value="1205" {{selected('1205', request('category'))}} >Member Cari Mitra</option> 
                                    <option value="1206" {{selected('1206', request('category'))}} >Member Cari Investor</option>
                                    <option value="1207" {{selected('1207', request('category'))}} >Fiqeeh Buku</option>
                                    <option value="1208" {{selected('1208', request('category'))}} >Fiqeeh Workshop</option>
                                    <option value="1209" {{selected('1209', request('category'))}} >Fiqeeh Konsultan</option>
                                </select>
                                {{-- <select name="status" class="form-control mr-1">
                                ...
                                <a href="{{route('export_harian_retensi')}}" class="btn btn-success mr-3"><i class="la la-download"></i>Daily Retention</a>
                                <a href="{{route('export_bulanan_retensi')}}" class="btn btn-success"><i class="la la-download"></i>Monthly Retention</a>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <p class="text-muted my-3"> <small>Showing {{$students->count()}} from {{$students->total()}} results</small> </p>
            ...
            <div class="row">
                <div class="col-sm-12">
                    ...
                    {!! $students->appends(['q' => request('q'), 'status'=> request('status'),'city'=> request('city'),'city'=> request('city'),'product'=> request('product'), 'start_date'=> request('start_date'), 'end_date'=> request('end_date')])->links() !!}

...
@include('admin.reports.menu')
    ...
    <div class="profile-settings-wrap">
        ...
        <h4 class="mb-3">Laporan Retensi</h4>
                    ...
                    <div class="col-md-12">
                        <div class="search-filter-form-wrap mb-3">
                            ...
                            <div class="input-group">
                                ...
                                <a href="{{route('export_harian_retensi')}}" class="btn btn-success mr-3"><i class="la la-download"></i>Login Today</a>
                                <a href="{{route('export_bulanan_retensi')}}" class="btn btn-success"><i class="la la-download"></i>Login This Month</a>
                            </div>
                        </div>
                    </div>
                </div>

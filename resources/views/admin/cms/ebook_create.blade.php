...
@section('page-header-right')
    <a href="{{route('ebooks')}}" class="btn btn-info" data-toggle="tooltip" title="Books"> <i class="la la-list"></i> Books </a>
@endsection
...
@section('content')
    ...
    <div class="row">
        <div class="col-sm-12">
            ...
            <form action="{{route('create_ebook')}}" method="post" enctype="multipart/form-data">
                @csrf
                ...
                <div class="form-group row {{ $errors->has('physic')? 'has-error':'' }}">
                    ...
                    <div class="col-sm-8">
                        <select name="physic" class="form-control">
                            <option value="0">Digital (Ebook)</option>
                ...
                <div class="form-group row" id="ebookFile">
                    <label for="additional_css" class="col-sm-4 control-label">File Book</label>
                    <div class="col-sm-8">
                        <input type="file" accept="application/pdf" class="form-control-file" id="file" value="{{ old('file') }}" name="file" placeholder="{{__a('file')}}" required>

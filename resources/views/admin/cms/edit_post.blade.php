        ...
        <div class="col-sm-12">
            ...
            <form action="" method="post" id="createPostForm" enctype="multipart/form-data">
                ...
                <div class="form-group row {{ $errors->has('author')? 'has-error':'' }}">
                    <div class="col-sm-12">
                        <input type="text" class="form-control" id="author" value="{{ old('author')?old('author'): $post->author }}" name="author" placeholder="Author">
                ...
                <div class="form-group row {{ $errors->has('meta_description')? 'has-error':'' }}">
                    <div class="col-sm-12">
                        <textarea type="text" class="form-control" id="meta_description" name="meta_description" rows="4" maxlength="160" placeholder="Meta Description Box : Max 160 character">{{ old('meta_description')?old('meta_description'): $post->meta_description }}</textarea>
                ...
                <div class="form-group row">
                    <div class="col-sm-12">
                        {!! image_upload_form('feature_image', $post->feature_image, [1000,563]) !!}
                    </div>
                </div>

...
<div class="navbar-default sidebar" role="navigation">
    ...
    <div class="sidebar-nav navbar-collapse">
        <ul class="nav" id="side-menu">
            ...
            <li> <a href="{{route('reports')}}"><i class="la la-file-invoice"></i> Laporan Start Date</a>  </li>
            
            <li> <a href="{{route('date_report')}}"><i class="la la-file-invoice"></i> Laporan End Date </a>  </li>

            {{-- payment Menu --}}
            <li>
                <a href="#"><i class="la la-user fa-fw"></i> Payment<span class="la arrow"></span></a>
                <ul class="nav nav-second-level" style="display: none;">
                    <li> <a href="{{route('payments')}}"><i class="la la-file-invoice-dollar"></i> Payment</a>  </li>
                    {{-- <li> <a href="{{route('payments_blasting')}}"><i class="la la-file-invoice-dollar"></i> Payment Blasting</a>  </li> --}}

        ...
        <tr>
            ...
            @for($i = 0; $i < $data['max_payment']; $i++)
                ...
                @endif
                    ...
                    @else
                    <td>
                        @if($student['payment'][$i]->product == null)
                        {{$student['payment'][$i]->product_ads}}
                        @elseif($student['payment'][$i]->product_ads == null)
                        {{$student['payment'][$i]->product}}
                        @else
                        Tidak Ada Data Ads/Product
                        @endif
                    </td>
                    @endif

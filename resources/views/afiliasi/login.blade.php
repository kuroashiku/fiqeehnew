...
<body class="{{get_option('enable_rtl')? 'rtl' : ''}} font-poppins">
    <div class="wrapper">
        <div class="flex flex-col justify-start lg:grid lg:grid-cols-12 lg:gap-4 lg:p-6 min-h-screen">
            ...
            <div class="lg:col-span-4 flex items-center py-10 lg:py-0 px-6 lg:px-0">
                <form role="form" method="POST" action="{{ route('login') }}" class="w-full">
                    @csrf
                    <h2 class="text-2xl lg:text-4xl font-semibold text-neutral-500 mb-8 lg:mb-16">
                        Masuk Akun Afiliasi
                    </h2>
                    @if(session('error'))
                        <div class="bg-red-100 border border-red-400 text-red-700 px-4 py-3 rounded relative" style="margin-bottom: 20px;" role="alert">
                    ...
                    <div class="grid grid-cols-7 lg:grid-cols-10 mb-6 lg:mb-[72px]">
                        ...
                        <div class="col-span-5 lg:col-span-7">
                            <input type="text" name="phone" id="phone" placeholder="Whatsapp" class="form-input w-full border-0 border-b border-neutral-300 py-2 px-0.5 text-sm lg:text-base font-normal text-neutral-500 placeholder:text-neutral-400 focus:outline-none focus:border-b-2 focus:ring-0 focus:border-brand-500 focus:ring-brand-500 mb-1" onkeypress="return onlyNumberKey(event)" required>
                            <div class="error normal-case text-xs lg:text-sm font-normal text-normal-500" data-value="false" style="font-size: 1rem;">Contoh : 8581234XXX</div>
                        </div>

                        <input name="user_as" value="afiliasi">
                    </div>
                    ...
                    <button type="submit" id="submit" class="w-full text-sm lg:text-base font-normal py-2.5 border rounded-lg mb-4 text-brand-50 bg-brand-500 border-brand-50">
                        Masuk
                    </button>
                    <div class="mb-14 lg:mb-16 flex items-center justify-between">
                        <div class="flex items-center text-warning-500">
                            <input type="checkbox" id="rememberme" name="rememberme" value="false" class="border border-neutral-200 rounded checked:border-0 checked:bg-brand-600 checked:ring-0 focus:ring-0 cursor-pointer w-4 lg:w-6 h-4 lg:h-6 m-0">
                            <label for="rememberme" class="text-sm lg:text-base font-normal text-neutral-300 cursor-pointer ml-2">Ingat saya</label>
                        </div>
{{--                        <a href="{{ route('forgot_password') }}" class="text-sm lg:text-base font-normal text-brand-600">--}}
{{--                            Lupa Sandi?--}}
{{--                        </a>--}}
                    </div>
                    <p class="text-sm lg:text-base font-normal text-neutral-400 text-center mb-4">
                        Tidak punya akun? <a href="{{route('register_afiliasi')}}" class="font-semibold hover:text-brand-500">Daftar</a>
                    </p>
                </form>
            </div>
            <div class="empty hidden lg:block"></div>

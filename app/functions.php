...
?>
        <div class="image-wrap" style="max-width: 100px;">
...
if (!function_exists('no_data')) {
    function no_data($title = '', $desc = '', $class = null)
    {
        ...
        $output = " <div class='no-data-screen-wrap text-center {$class} '>
            <img src='{$no_data_img}' style='max-height: 250px;width: auto;margin: auto;' />
...
if (!function_exists('clean_html')) {
    ...
    {
        if ($text) {
            $text = strip_tags($text, '<h1><h2><h3><h4><h5><h6><p><br><ul><li><hr><a><abbr><address><b><blockquote><center><cite><code><del><i><ins><strong><sub><sup><time><u><img><iframe><link><nav><ol><table><caption><th><tr><td><thead><tbody><tfoot><col><colgroup><div><span><em>');

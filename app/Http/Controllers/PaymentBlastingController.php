...
class PaymentBlastingController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('admin.paymentsblasting.payment_blasting', compact('title', 'payments', 'followUp'));
    }

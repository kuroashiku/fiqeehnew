...
function dashboard_menu()
{
    ...
    if ($user->isInstructor()) {
        ...
        $menu = apply_filters('dashboard_menu_for_instructor', [
            ...
            'reports' => [
                ...
                'is_active' => request()->is('dashboard/reports*'),
            ],
        ]);
    }
    ...
    if ($user->user_type == 'afiliasi') {
        $menu = [
            'payment-afiliasi' => [
                'name' => "Pembayaran",
                'icon' => '<i class="la la-file-invoice-dollar"></i>',
                'is_active' => request()->is('afiliasi/payment*'),
            ],
            'afiliasi-profile-settings' => [
                'name' => "Profile",
                'icon' => '<i class="la la-user"></i>',
                'is_active' => request()->is('afiliasi/settings*'),
            ]
        ];
    }

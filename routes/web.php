...
Route::group(['prefix' => 'admin', 'middleware' => ['auth', 'admin']], function () {
    ...
    Route::group(['prefix' => 'payments_blasting'], function () {
        Route::get('/deleted', 'PaymentBlastingController@indexDeleted')->name('deleted_payments');
        Route::get('/', 'PaymentBlastingController@index')->name('payments_blasting');
        Route::get('view/{id}', 'PaymentBlastingController@view')->name('payment_view');
        Route::get('delete/{id}', 'PaymentBlastingController@delete')->name('payment_delete');
        Route::get('deletes/{id}', 'PaymentBlastingController@deletes')->name('payment_deletes');
        Route::post('edit/{id}', 'PaymentBlastingController@editPayment')->name('edit-payment');
        Route::post('update-status/{id}', 'PaymentBlastingController@updateStatuss')->name('update_statuss');
        Route::post('follow-up/{id}', 'PaymentBlastingController@followUp')->name('follow_up');
        Route::post('follow-up-update', 'PaymentBlastingController@followUpText')->name('follow_up_text');
    });
    Route::group(['prefix' => 'boardcast'], function () {
        Route::get('/', 'BoardcastController@index')->name('boardcast');
    });
    ...
    Route::group(['prefix' => 'reports'], function () {
        ...
        Route::get('/report_retention', 'DashboardController@reportRetensi')->name('report_retention');
        Route::get('/export/daily_retention', 'DashboardController@exportRetensiHarian')->name('export_harian_retensi');
        Route::get('/export/monthly_retention', 'DashboardController@exportRetensiBulanan')->name('export_bulanan_retensi');
        Route::get('/export/jatuh_tempo', 'DashboardController@exportJatuhTempo')->name('export_jatuh_tempo');
...
Route::get('about-us', 'HomeController@aboutUs')->name('about_us');
 ...
 Route::get('marketplace', 'HomeController@pageMarket')->name('market');

    ...
    <div class="profile-settings-wrap">
        ...
        <form action="" method="post">
            ...
            <div class="profile-basic-info bg-white p-3">
                ...
                <h4 class="my-4">Account Bank </h4>


                <div class="form-row">
                    <div class="form-group col-md-6">
                        <label>Bank Account Code</label>
                        <input type="text" class="form-control" name="afiliasi_bank_code" value="{{$user->afiliasi_bank_code}}">
                        <span class="text-muted">Contoh : BCA, BRI, Mandiri</span>
                    </div>
                    <div class="form-group col-md-6">
                        <label>Bank Account Number</label>
                        <input type="text" class="form-control" name="afiliasi_bank_account" value="{{$user->afiliasi_bank_account}}" >
                    </div>
                </div>

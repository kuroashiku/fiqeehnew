        ...
        <div class="card-body">
            ...
            <form method="post">
                ...
                <div class="form-group">
                    <label for="short_description">Free Description</label>
                    <div class="input-group">
                        <textarea name="short_description" id="short_description" class="form-control" placeholder="{{__t('course_short_desc_eg')}}"></textarea>
                        {{-- <div class="input-group-append">
                ...
                <div class="form-row my-3">
                    ...
                    <div class="col">
                        ...
                        <div class="form-group {{ $errors->has('is_certificate') ? ' has-error' : '' }}">
                            ...
                            {!! switch_field('is_certificate', 'Enable Certificate', 0) !!}
                        </div>

                        <div class="form-group {{ $errors->has('author') ? ' has-error' : '' }}">
                            <label class="mb-3">Author</label>
                            <input type="text" name="author" class="form-control" id="author" placeholder="Author Course" value="{{old('author')}}">
                        </div>
                ...
                <div class="form-row my-5">
                    <div class="col">
                        <div class="form-group">
                            ...
                            {!! image_upload_form('mentor_image_id', null, [500,500]) !!}
                    ...
                    <div class="col">
                        <div class="form-group {{ $errors->has('mentor') ? ' has-error' : '' }}">
                            ...
                            <input type="text" name="mentor" class="form-control" id="mentor" placeholder="Mentor Course" value="">
                        </div>
                        <div class="form-group {{ $errors->has('mentor_job') ? ' has-error' : '' }}">
                            <label class="mb-3">Mentor Job</label>
                            <input type="text" name="mentor_job" class="form-control" id="mentor_job" placeholder="Mentor Job" value="">
                        </div>
                        <div class="form-group {{ $errors->has('mentor_desc') ? ' has-error' : '' }}">
                            <label class="mb-3">Mentor Description</label>
                            <textarea type="text" name="mentor_desc" class="form-control" id="mentor_desc" placeholder="Mentor Description"></textarea>
                        </div>
                    </div>
                </div>

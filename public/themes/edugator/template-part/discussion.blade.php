...
<div id="course-discussion-wrap">
    ...
    <div class="discussion-ask-question-form bg-transparent my-4 p-4">
        <form action="{{route('ask_question')}}" method="post">
            ...
            <input type="hidden" class="form-control" name="title" value="Pertanyaan">
            ...
            <button type="submit" class="btn" style="background: rgba(255, 200, 0, 1);"><i class="la la-question-circle-o"></i> {{__t('ask_question')}} </button>
        </form>
        ...
        @foreach($content->discussions as $discussion)
            @if ($discussion->user->id == auth()->user()->id)
                <div class="discussion-single-wrap border p-3 mb-4">
                    ...
                    <div class="discusison-details-wrap" style="color: black;">
                            ...
                            <div class="discussion-reply-wrap border p-3 bg-white">
                                <div class="discussion-user d-flex mb-4">
                                    ...
                                    <div class="discussion-user-name flex-grow-1">
                                        ...
                                        <a href="{{route('discussion_reply', $reply->id)}}" style="color: black;">
                                            <h4>{{$reply->title}}</h4>
                                        </a>

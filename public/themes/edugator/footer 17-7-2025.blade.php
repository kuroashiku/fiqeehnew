...
<footer class="px-6 lg:px-36 bg-neutral-600">
    <div class="container mx-auto">
        ...
        <div class="block md:flex justify-between items-center py-6 lg:py-8">
            ...
            <div>
                <a href="https://www.facebook.com/profile.php?id=61556589569099" class="text-2xl font-normal inline-block text-neutral-300" target="_blank">
                ...
                <a href="https://t.me/fiqeeh2022" class="ml-8 lg:ml-10 text-2xl font-normal inline-block text-neutral-300" target="_blank">
                    <i class="fa-brands fa-telegram"></i>
                </a>
                <a href="https://www.tiktok.com/@fiqeeh?_t=ZS-8u5t1M8aj7x&_r=1" class="ml-8 lg:ml-10 text-2xl font-normal inline-block text-neutral-300" target="_blank">

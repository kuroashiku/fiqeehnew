        ...
        <div class="col-md-12 ">
            <div class="card auth-card">
                ...
                <div class="card-body">
                    ...
                    <h1 class="mb-4 text-center" style="color: #0E9ED2;">Lupa Sandi?</h1>

                    <p class="mb-4 text-center" style="color: #0E9ED2;">Masukkan Nomor Whatsapp Terdaftar anda Untuk Membuat Sandi Baru</p>
                    ...
                    <form action="" class="form-horizontal" method="POST">
                        ...
                        <div class="col-span-5 lg:col-span-7">
                            <input type="text" name="phone" id="phone" placeholder="Whatsapp" class="form-input w-full border-0 border-b border-neutral-300 py-2 px-0.5 text-sm lg:text-base font-normal text-neutral-500 placeholder:text-neutral-400 focus:outline-none focus:border-b-2 focus:ring-0 focus:border-brand-500 focus:ring-brand-500 mb-1" onkeypress="return onlyNumberKey(event)" value="{{ old('phone') }}" required>
                        ...
                        <div class="form-group">
                            <button type="submit" class="w-full text-sm lg:text-base font-normal py-2.5 border rounded-lg mb-4 text-brand-50 bg-brand-500 border-brand-50">
                                Kirim Link Sandi Baru
                            </button>
                        </div>
                    </form>

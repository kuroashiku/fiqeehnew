            ...
            <div class="col-md-8 offset-md-2">
                ...
                <div class="question-wrap">
                    ...
                    <form action="{{route('quiz_attempt_url', $quiz->id)}}" method="post" class="quiz-question-submit">
                        ...
                        <h2 class="question-title d-flex mb-3" style="color: #fff;">
                        ...
                        <div class="question-single-wrap">
                                ...
                                <div class="attempt-options-wrap d-flex mb-4">
                                    @foreach($question->options as $option)
                                        <div class="question-option">
                                            <label class="{{$question->type}} m-0 bg-transparent" style="color: #fff;">
                                                <input type="{{$question->type}}" name="questions[{{$question->id}}]{{$question->type === 'checkbox' ? '[]' : ''}}" value="{{$option->id}}" style="color: #fff;"><span></span>
                                                {{$option->title}}
                                            </label>
                                        </div>
                            ...
                            @elseif($question->type === 'text' )
                                <div class="form-group bg-transparent" style="color: #fff;">
                        ...
                        <button type="submit" name="question-submit-btn" class="btn btn-lg question-submit-btn" style="background: rgba(255, 200, 0, 1);">
                            @if($q_number == $q_limit)

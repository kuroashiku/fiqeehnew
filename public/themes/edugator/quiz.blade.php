...
@section('content')
    ...
    <div class="lecture-container-wrap d-flex">
        ...
        <div class="lecture-container">
            ...
            <h1 class="lecture-title mb-4 text-center" style="
            font-size: 40px;
        "><b>Sudah siap menjawab soal?</b></h1>
            @if($isEnrolled)
                ...
                <div class="quiz-instruction-wrapper">
                    ...
                    @if(! $attempt || $attempt->status !== 'finished')
                        <div class="assignment-header-info bg-transparent mb-4 p-3 col-md-6 offset-md-3 text-center" style="border: none;">
                            <h4 class="mb-4">Instruksi</h4>

                            <p class="assignment-basic-info mb-2">
                                <span class="mr-4"> <i class="la la-clock"></i> <strong> Durasi : </strong> {{$quiz->option('time_limit')}} Minutes </span>

                                <span class="mr-4"><i class="la la-chart-pie"></i> <strong> Total Pertanyaan : </strong> {{$quiz->option('questions_limit')}}</span>
                                <span class="mr-4"><i class="la la-check-circle"></i> <strong> Minimum Skor : </strong> {{$quiz->option('passing_score')}}%</span>
                            </p>
                    ...
                    {{$attempt->ended_at->diffInMinutes($attempt->created_at)}} {{__t('minutes')}}
                            ...
                            <div class="quiz-result-gretings">
                                @if($attempt->passed)
                                    <div class="bg-transparent text-white p-3 text-center">
                                ...
                                <div class="attempt-given-answers-wrap">
                                    <div class="row">
                                        ...
                                        @foreach($answers as $answer)
                                            ...
                                            <div class="col-md-6">
                                                <div class="view-attempted-answer bg-transparent p-3 mb-3">
                    ...
                    @else
                        <div id="start-quiz-btn-wrapper" class="mt-5 col-md-2 offset-md-5">
                            <button id="btn-start-quiz" class="btn btn-success btn-lg btn-block" data-quiz-id="{{$quiz->id}}">

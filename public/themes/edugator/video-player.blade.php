...
@endphp
<h2 class="text-center textloading">
    Loading Video...
</h2>
<div class="lecture-video-wrapper video-player-wrapper videonya" style="display: none;">
    ...
    @if($video_source === 'youtube')
        <video
            ...
            controls
            preload="auto"
            data-setup='{ "fluid": true, "techOrder": ["youtube"], "sources": [{ "type": "video/youtube", "src": "{{$src_youtube}}"}] }'
        >
        </video>
    @endif
    ...
    @if($video_source === 'vimeo')
        <video id="lecture_video" class="video-js vjs-fluid vjs-default-skin" controls
               data-setup='{ "fluid": true, "techOrder": ["vimeo"], "sources": [{ "type": "video/vimeo", "src": "{{$src_vimeo}}"}] }'>
        </video>
    @endif
    @if($text)
